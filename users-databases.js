...
const usersTimeline=[
    ...
    {username:"Mariana",timeline:"A mi me gusta más el café que el té",},{username:"Andres",timeline:"Yo hoy no quiero trabajar",}
];
...
function signIn(username,password){
    ...
    alert(`Bienvenido a tu cuenta ${username}`);console.log(usersTimeline);
    }
    else{
